        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 fh5co-gallery_item">
                    <div class="fh5co-bg-img" style="background-image: url({{ asset('tpt/images/gallery_1.jpeg') }});"
                        data-trigger="zoomerang"></div>
                    <div class="fh5co-bg-img" style="background-image: url({{ asset('tpt/images/gallery_2.jpeg') }});"
                        data-trigger="zoomerang"></div>
                </div>
                <div class="col-md-6 col-sm-6 fh5co-gallery_item">
                    <div class="fh5co-bg-img fh5co-gallery_big"
                        style="background-image: url({{ asset('tpt/images/gallery_8.jpeg') }});" data-trigger="zoomerang">
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 fh5co-gallery_item">
                    <div class="fh5co-bg-img" style="background-image: url({{ asset('tpt/images/gallery_4.jpeg') }});"
                        data-trigger="zoomerang"></div>
                    <div class="fh5co-bg-img" style="background-image: url({{ asset('tpt/images/gallery_5.jpeg') }});"
                        data-trigger="zoomerang"></div>
                </div>
                ...
                <div class="col-md-7 animate-box" data-animate-effect="fadeInRight">
                    <blockquote>
                        <p>&ldquo; Quantum ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis ab debitis sit
                            itaque totam, a maiores nihil, nulla magnam porro minima officiis! &rdquo;</p>
        ...
        <div class="container">
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                    <h2>Book a Table</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae enim quae vitae cupiditate.</p>
