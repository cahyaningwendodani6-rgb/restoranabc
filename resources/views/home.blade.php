        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                        <div class="fh5co-item">
                            <img src="{{ asset('tpt/images/Chicken Salted Egg.jpg') }}" class="img-responsive"
                                alt="">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                        <div class="fh5co-item">
                            <img src="{{ asset('tpt/images/Teriyaki-Salmon-Bowl.jpg') }}" class="img-responsive"
                                alt="">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                        <div class="fh5co-item margin_top">
                            <img src="{{ asset('tpt/images/Sup Ayam Fillet.jpg') }}" class="img-responsive"
                                alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item margin_top">
                                <img src="{{ asset('tpt/images/es jerukk.jpg') }}" class="img-responsive"
                                    alt="">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item margin_top">
                                <img src="{{ asset('tpt/images/macha latte.jpg') }}" class="img-responsive"
                                    alt="">
                                <h3>Matcha Latte</h3>
                                <span class="fh5co-price">Rp22.000</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item">
                                <img src="{{ asset('tpt/images/thai tea.jpeg') }}" class="img-responsive"
                                    alt="">
                                <h3>Thai Tea</h3>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item">
                                <img src="{{ asset('tpt/images/taro latte.jpeg') }}" class="img-responsive"
                                    alt="">
                                <h3>Taro Latte</h3>
                                <span class="fh5co-price">Rp20.000</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item margin_top">
                                <img src="{{ asset('tpt/images/kopi hitam.jpeg') }}" class="img-responsive"
                                    alt="">
                                <h3>Kopi Hitam</h3>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item">
                                <img src="{{ asset('tpt/images/cappucino.jpg') }}" class="img-responsive"
                                    alt="">
                                <h3>Cappuccino</h3>
                                <span class="fh5co-price">Rp18.000</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item margin_top">
                                <img src="{{ asset('tpt/images/jus alpukat.jpg') }}" class="img-responsive"
                                    alt="">
                                <h3>Jus Alpukat</h3>
                                <span class="fh5co-price">Rp20.000</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item">
                                <img src="{{ asset('tpt/images/jus mangga.jpg') }}" class="img-responsive"
                                    alt="">
                                <h3>Jus Mangga</h3>
                                <span class="fh5co-price">Rp18.000</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item margin_top">
                                <img src="{{ asset('tpt/images/lemon tea.jpg') }}" class="img-responsive"
                                    alt="">
                                <h3>Lemon Tea</h3>
                                <span class="fh5co-price">Rp12.000</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item margin_top">
                                ...
                                <span class="fh5co-price">Rp35.000</span>
                                <p>Teh susu lembut dengan rasa ubi ungu manis, dipadukan boba kenyal yang bikin nagih.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item margin_top">
                                <img src="{{ asset('tpt/images/onion rings.jpg') }}" class="img-responsive"
                                    alt="">
                                <h3>Onion Rings</h3>
                                <span class="fh5co-price">Rp18.000</span>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 fh5co-item-wrap animate-box">
                            <div class="fh5co-item">
                                <img src="{{ asset('tpt/images/roti bakar.jpg') }}" class="img-responsive"
                                    alt="">
                    ...
                    <div class="row animate-box">
                        <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                            ...
                            <p>Ingin makan enak tanpa ribet?
                                Pesan sekarang secara online dan nikmati hidangan favorit Anda dengan cepat, praktis,
                                dan
                                higienis.
                            </p>
